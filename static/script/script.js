...
function generateReportPdf() {
  ...
  // Outcome only (no “Status:” label if you prefer minimal)
  ...
  // ---- Answers list (no “Questions & Answers” heading) ----
  doc.setFont("helvetica", "normal"); doc.setFontSize(11);
  ...
  // (Optional) Unanswered list – remove this block entirely if you don’t want it
  if (unknown.length) {
  ...
  // IMPORTANT: no References section here.
